...
# Topics: Number, Algebra, Geometry, Ratio/Proportion, Data, Measurement

MATH_LIST = [
    # ==========================
    # LEVEL 1-3: EASY (Foundation / Speed Skills)
    # ==========================
    {
    ...
    # ==========================
    # LEVEL 4-7: MEDIUM (Standard 11+ Level)
    # ==========================
    # --- FRACTIONS & DECIMALS ---
    {
    ...
    # ==========================
    # LEVEL 8-10: HARD (Scholarship / Competitive Grammar)
    # ==========================
    {
